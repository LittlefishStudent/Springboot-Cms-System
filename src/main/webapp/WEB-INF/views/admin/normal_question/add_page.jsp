...
<c:set var="uri" value="${pageContext.request.contextPath}" />
    ...
    var uri='${uri}';
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/static/admin/layui/css/layui.css">
            ...
            <input type="text"  style="display:inline;width:500px;"  placeholder="请输入问题标题" id="questionTitle" class="layui-input">	<span style="color:red">*必填</span>
            ...
            <div class="layui-input-block">
            <textarea  placeholder="请输入问题描述"  id="questionIntro"  rows="15" cols="100"></textarea>	<span style="color:red">*必填</span>
            ...
            <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/jquery-1.11.1.min.js"></script>
                ...
                <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/layui/layui.js"></script>
                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=3060"></script>
                        ...
                        function submitData(){
                            ...
                            $.ajax({
                                type: 'post',
                                url: '${pageContext.request.contextPath}/admin/normal_question/add_submit',
                                    data:{
