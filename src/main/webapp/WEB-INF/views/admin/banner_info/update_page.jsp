    ...
    var uri='${uri}';
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/static/admin/layui/css/layui.css">
            <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/common/webupload/webuploader.css">
                ...
                <div class="imgUpload" tip="请上传底层幻灯片，数量不超过1" red-tip="(*必填)"   upload-num="1" init-val="${data.bannerImg1}" upload-type="1" id="bannerImg1"></div>
                    ...
                    <div class="layui-input-block">
                    <div class="imgUpload" tip="请上传文字幻灯片，数量不超过1" red-tip="(*必填)"   upload-num="1" init-val="${data.bannerImg2}" upload-type="1" id="bannerImg2"></div>
                        ...
                        <div class="layui-input-block">
                        <div class="imgUpload" tip="请上传边框幻灯片，数量不超过1" red-tip="(*必填)"   upload-num="1" init-val="${data.bannerImg3}" upload-type="1" id="bannerImg3"></div>
                            ...
                            <div class="layui-input-block">
                            <input type="text"  style="display:inline;width:500px;" value="${data.bannerTxt}" placeholder="请输入幻灯片名" id="bannerTxt" class="layui-input">	<span style="color:red">*必填</span>
                                ...
                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/jquery-1.11.1.min.js"></script>
                                    ...
                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/layui/layui.js"></script>
                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=4881"></script>
                                                ...
                                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/webupload/upload.js"></script>
                                                    ...
                                                    $(function(){
                                                        ...
                                                        function submitData(){
                                                            ...
                                                            $.ajax({
                                                                type: 'post',
                                                                url: '${pageContext.request.contextPath}/admin/banner_info/update_submit',
                                                                    data:{
                                                                        "id":'${data.id}',
