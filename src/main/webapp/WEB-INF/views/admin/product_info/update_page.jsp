    ...
    var uri='${uri}';
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/static/admin/layui/css/layui.css">
            <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/common/webupload/webuploader.css">
                ...
                <input type="text"  style="display:inline;width:500px;" value="${data.proName}" placeholder="请输入产品名" id="proName" class="layui-input">	<span style="color:red">*必填</span>
                            ...
                            <option value="${item.id}" selected>${item.name}</option>
                                ...
                                <c:if test="${item.id!=data.proTypeId}">
                                    <option value="${item.id}">${item.name}</option>
                                        ...
                                        <div class="layui-input-block">
                                        <div class="imgUpload" tip="请上传产品大图，数量不超过1" red-tip="(*必填)"   upload-num="1" init-val="${data.proImg}" upload-type="1" id="proImg"></div>
                                            ...
                                            <div class="layui-input-block">
                                            <textarea  placeholder="请输入产品详情"  id="proIntro"  rows="15" cols="100">${data.proIntro}</textarea>	<span style="color:red">*必填</span>
                                                ...
                                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/jquery-1.11.1.min.js"></script>
                                                    ...
                                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/layui/layui.js"></script>
                                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=2355"></script>
                                                                        ...
                                                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/selectSearch/jquery.searchableSelect.js?d=1293393"></script>
                                                                            ...
                                                                            $(function(){
                                                                                ...
                                                                                function submitData(){
                                                                                    ...
                                                                                    $.ajax({
                                                                                        type: 'post',
                                                                                        url: '${pageContext.request.contextPath}/admin/product_info/update_submit',
                                                                                            data:{
                                                                                                "id":'${data.id}',
