            ...
            <input type="text"  style="display:inline;width:500px;" value="${data.typeName}" placeholder="请输入类型名" id="typeName" class="layui-input">	<span style="color:red">*必填</span>
                ...
                <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/jquery-1.11.1.min.js"></script>
                    ...
                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/layui/layui.js"></script>
                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=9302"></script>
                            ...
                            function submitData(){
                                ...
                                $.ajax({
                                    type: 'post',
                                    url: '${pageContext.request.contextPath}/admin/news_type_info/update_submit',
                                        data:{
                                            "id":'${data.id}',
