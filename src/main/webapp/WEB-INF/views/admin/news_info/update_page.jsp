            ...
            <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/common/webupload/webuploader.css">
                ...
                <input type="text"  style="display:inline;width:500px;" value="${data.title}" placeholder="请输入标题" id="title" class="layui-input">	<span style="color:red">*必填</span>
                    ...
                    <c:forEach items="${newsTypeInfoList}" var="item">
                        <c:if test="${item.id==data.newsTypeId}">
                            <option value="${item.id}" selected>${item.name}</option>
                                ...
                                <c:if test="${item.id!=data.newsTypeId}">
                                    <option value="${item.id}">${item.name}</option>
                                        ...
                                        <div class="layui-input-block">
                                        <div class="imgUpload" tip="请上传新闻大图，数量不超过1" red-tip="(*必填)"   upload-num="1" init-val="${data.newsImg}" upload-type="1" id="newsImg"></div>
                                            ...
                                            <div class="layui-input-block">
                                            <input type="text"  style="display:inline;width:500px;" value="${data.publishName}" placeholder="请输入发布人" id="publishName" class="layui-input">	<span style="color:red">*必填</span>
                                                ...
                                                <div class="layui-input-block">
                                                <input type="text" class="layui-input Wdate"  readonly="readonly"  style="display:inline;width:500px;" value="${data.publishDate}"  onFocus="WdatePicker({startDate: '%y-%M-%d' })"  placeholder="请输入发布日期" id="publishDate">	<span style="color:red">*必填</span>
                                                            ...
                                                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/wangeditor-3.0.17/wangEditor.min.js"></script>
                                                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/wangeditor-3.0.17/wangeditor_emotion.js"></script>
                                                                    ...
                                                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/layui/layui.js"></script>
                                                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=3168"></script>
