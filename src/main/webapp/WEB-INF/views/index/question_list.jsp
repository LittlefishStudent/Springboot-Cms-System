      ...
      <div class="wk_lonav">
        ...
        <div class="wk_inav">
          <ul class="nav">
            ...
            <li><a href="${pageContext.request.contextPath}/commonapi/question"  style="color:#90C42F">常见问题</a></li>
        ...
        <div class="wk_c_right_name">
          <div class="wk_c_right_name_r">
            <ul>
              ...
              <li> <span>您现在的位置：</span> <a href='${pageContext.request.contextPath}/'>主页</a> > <a href='${pageContext.request.contextPath}/commonapi/question'>常见问题</a> >  </li>
            </ul>
          </div>
        </div>
...
ajaxList(1);
                                            ...
                                            function ajaxList(page) {
                                                    ...
                                                    $.ajax({
                                                        type : 'get',
                                                        url : "${pageContext.request.contextPath}/commonapi/question/search",
                                                            data : {
                                                                "page":page,
                                                            ...
                                                            success : function(result) {
                                                                ...
                                                                for (var i = 0; i < rows.length; i++) {
                                                                	...
                                                                	html+='<li class="cl">';
                                                                	html+='<h2><a href="#"  class="xi2" title="'+rows[i].questionTitle+'"  style="">'+rows[i].questionTitle+'</a> </h2>';
                                                                	html+='<p class="wk_bm_sm">'+rows[i].questionIntro+'</p>';
                                                                	html+='<span class="xg1">';
                                                                	html+='<span class="xg1">时间: '+rows[i].createTime+'</span> </span> </li>';
