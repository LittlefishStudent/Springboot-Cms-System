      ...
      <div class="wk_lonav">
        ...
        <div class="wk_inav">
          <ul class="nav">
            ...
            <li><a href="${pageContext.request.contextPath}/commonapi/about" style="color:#90C42F">关于我们</a></li>
          ...
          <div id="portal_block_18" class="block move-span">
            <div id="portal_block_18_content" class="dxb_bc">
              <div class="portal_block_summary">
                ...
                <p>杭州宁然网络科技有限公司是一家杭州专业的seo优化公司,以领先优化技术实力打造行业品牌流量，是专业致力于杭州seo网站优化、百度关键词优化排名、万词霸屏以及杭州网站建设等服务的杭州网络营销推广优化公司,技术领先的国内智能SEO优化服务商，坚持只做“有用的网站”和“有价值的网络营销”，追求商业策划与数据分析，帮助广大客户顺利对接上历次互联网浪潮，准确优选出符合自己需要的互联网运用，也为无数年轻人创造了职业和事业的成功故事，造就了中国互联网行业大量职业经理人、创业者和品牌领军人物
<div>
	&nbsp;</div>
<div>
        ...
        <div id="framep2n1bg_left" class="column frame-1-c">
          ...
          <div id="portal_block_19" class="block move-span">
            <div id="portal_block_19_content" class="dxb_bc">
              <div class="portal_block_summary">
                <dl>
                  <dd><img src="${pageContext.request.contextPath}/static/index/style/images/guanyu_04.png"></dd>
                  <dt>
                    <h2>我们沉浸于用户体验</h2>
                  </dt>
                  <dt>
                ...
                <dl>
                  <dd><img src="${pageContext.request.contextPath}/static/index/style/images/guanyu_06.png"></dd>
                  <dt>
                    <h2>服务思维下的商业设计</h2>
                  </dt>
                  <dt>
                ...
                <dl>
                  <dd><img src="${pageContext.request.contextPath}/static/index/style/images/guanyu_08.png"></dd>
                  <dt>
                    <h2>精益合作和分享的态度</h2>
                  </dt>
                  <dt>
            ...
            <div id="portal_block_20_content" class="dxb_bc">
              <div class="portal_block_summary">
                ...
                <div class="project_con">
                  <dl>
                    <dd style="background:url(${pageContext.request.contextPath}/static/index/style/images/xiangmu_03.jpg) no-repeat center center;background-size:cover"><a href="#"></a></dd>
                    <dt>从创始至今，我们的业务方向始终不变，专注做好一件事才能更好的追求高品质，这也是我们存在的价值。在未来我们也是基于此信念而继续创造。</dt>
                  </dl>
                  <dl>
                    <dd style="background:url(${pageContext.request.contextPath}/static/index/style/images/xiangmu_05.jpg) no-repeat center center;background-size:cover"><a href="#"></a></dd>
                    <dt>在不断的创新和实践中总结出可持续和可信赖的设计流程，坚持与用户一起思考，用设计的方法发现问题、解决问题、输出设计方案，并实现客户产品和企业价值的提升。</dt>
                  </dl>
                  <dl>
                    <dd style="background:url(${pageContext.request.contextPath}/static/index/style/images/xiangmu_07.jpg) no-repeat center center;background-size:cover"><a href="#"></a></dd>
          ...
          <div id="portal_block_21" class="block move-span">
            <div id="portal_block_21_content" class="dxb_bc">
              <div class="portal_block_summary">
                ...
                <div class="team_con">
                  <div class="left_cor">
                    <div class="boxgrid" style="background:url(${pageContext.request.contextPath}/static/index/style/images/team_2.jpg) no-repeat;background-size:cover">
                      <div class="cover">
                        <h3>团队建设活动摄影</h3>
                      </div>
                    </div>
                    <div class="boxgrid" style="background:url(${pageContext.request.contextPath}/static/index/style/images/team_3.jpg) no-repeat;background-size:cover">
                      <div class="cover">
                        <h3>团队建设活动摄影</h3>
                      </div>
                    </div>
                    <div class="boxgrid" style="background:url(${pageContext.request.contextPath}/static/index/style/images/team_4.jpg) no-repeat;background-size:cover">
                      <div class="cover">
                        <h3>团队建设活动摄影</h3>
                      </div>
                    </div>
                    <div class="boxgrid" style="background:url(${pageContext.request.contextPath}/static/index/style/images/team_5.jpg) no-repeat;background-size:cover">
                      <div class="cover">
                        <h3>团队建设活动摄影</h3>
                      </div>
                    </div>
                  ...
                  <div class="right_cor">
                    <div class="boxgrid" style="background:url(${pageContext.request.contextPath}/static/index/style/images/team_6.jpg) no-repeat;background-size:cover">
                      <div class="cover1">
                        <h3>团队建设活动摄影</h3>
                      </div>
                    </div>
